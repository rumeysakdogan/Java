...
public class AboutMyself
{
    public static void main(String[] args)
    {
        ...
        System.out.println("\tMy name is 'Rumeysa'.");
        System.out.println("My favorite TV-Series are \"The Good Doctor\" and \"Anne of Green Gables\".");
        System.out.println("My favorite book is \"Anda sirlanmis Hayat\".");
